<aside class="navbar navbar-vertical navbar-expand-lg navbar-dark">
    <div class="container">
      ...
      <a href="." class="navbar-brand navbar-brand-autodark">
        <img src="/images/lewike-logo.svg" alt="Tabler" class="navbar-brand-image">
      </a>
      <div class="collapse navbar-collapse" id="navbar-menu">
        <ul class="navbar-nav pt-lg-3" id="admin-menu">
          <li class="nav-item">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle has-arrow" href="#" aria-expanded="true">
            ...
            <ul class="dropdown-menu show">
              ...
              <li >
                <a class="dropdown-item" href="/admin/cate" >
                  分类管理
                </a>
              </li>
              <li >
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu show">
              ...
              <li >
                <a class="dropdown-item" href="/admin/pinche/recharge" >
                  充值记录
                </a>
              </li>
              <li >
                <a class="dropdown-item" href="/admin/pinche/consume" >
                  消费记录
                </a>
              </li>
              <li >
                <a class="dropdown-item" href="/admin/pinche/config" >
                  参数配置
                </a>
              </li>
            </ul>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu show">
              <li >
                <a class="dropdown-item" href="/admin/wed/member" >
                  会员管理
                </a>
              </li>
              <li >
                <a class="dropdown-item" href="/admin/wed/deposit" >
                  充值记录
                </a>
              </li>
              <li >
                <a class="dropdown-item" href="/admin/wed/activity" >
                  活动管理
                </a>
              </li>
              <li >
