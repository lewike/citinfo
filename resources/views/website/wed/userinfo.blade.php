                    ...
                    <div class="weui-cells__group weui-cells__group_form">
                        <div class="weui-cells weui-cells_radio">
                            <label class="weui-cell weui-cell_active weui-check__label" for="marry1">
                                ...
                                <div class="weui-cell__ft">
                                    <input type="radio" class="weui-check" name="marry" id="marry1" value="1" checked="checked">
                                    <span class="weui-icon-checked"></span>
                                </div>
                            </label>
                            <label class="weui-cell weui-cell_active weui-check__label" for="marry2">
                                ...
                                <div class="weui-cell__ft">
                                    <input type="radio" name="marry" class="weui-check" id="marry2" value="2">
                                    <span class="weui-icon-checked"></span>
                                </div>
                            </label>
                            <label class="weui-cell weui-cell_active weui-check__label" for="marry3">
                                ...
                                <div class="weui-cell__ft">
                                    <input type="radio" name="marry" class="weui-check" id="marry3" value="3">
                                    <span class="weui-icon-checked"></span>
                                </div>
                            </label>
                        </div>
...
$(function(){
    ...
    $('.btn-complete-userinfo').click(function(){
        axios.post('/wed/userinfo/complete', $('.form-complete-userinfo').serialize())
