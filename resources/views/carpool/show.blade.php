      ...
      <div class="weui-panel">
        ...
        <div class="carpool-show-content">
            ...
            <div class="show-post-tips">
                ...
                <p>【{{$config['webname']}}】对其不提供任何保证，不承担任何责任</p>
                <p>友情提示：提高警惕，谨防诈骗</p>
              </div>
        </div>
      </div>
      <div class="weui-footer footer">
        <p><a href="/weixin/pinche/user">管理我的信息</a></p>
...
<script>
  ...
  var config = {!!$app->jssdk->buildConfig(['updateAppMessageShareData', 'updateTimelineShareData'], false)!!};
  wx.config(config);
  wx.ready(function () {
      wx.updateAppMessageShareData({ 
          title: '{{$share['title']}}',
          desc: '{{$share['desc']}}',
          link: host+'/weixin/pinche/show/{{$carpool->id}}{{$stick == 'free'? '?stick=sharefree': ''}}',
          imgUrl: '{{$share['image']}}',
          success: function () {
          }
      })
